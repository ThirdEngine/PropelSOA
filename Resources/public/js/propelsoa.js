function launchPropelSOA(propelSOAApp, debugMode, domain, customSOAPath, alternateInclude)
{
  ...
  propelSOAApp.factory('PropelSOAService', function($http, $q)
  {
    function PropelSOAFactory()
    {
      ...
      /**
       * This method will send a simple call to the API.
       *
       * @param url
       * @param method
       * @param data
       * @param ignoreAuthModule
       */
      this.callApi = function (url, method, data, ignoreAuthModule)
      {
        var config = {
          url: env_url + url,
          method: method,
      ...
      /**
       * This method will save an array of propel soa objects.
       *
       * @param array
       * @return promise
       */
